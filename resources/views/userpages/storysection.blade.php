    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12" style="padding: 0;">
                <img src="https://via.placeholder.com/600x400" alt="Image" class="img-fluid" style="width: 100%; height: auto; border-radius: 8px;">
            </div>

            <!-- Right Column with Heading/Paragraph/Button -->
            <div class="col-lg-6 col-md-12 d-flex justify-content-center align-items-center" style="padding: 20px;">
                <div class="text-content storypage" style="color: #fff; text-align: center;">
                    ...
                    <p style="font-size: 16px; color: #ccc; line-height: 1.6; margin-bottom: 20px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus ac justo nulla. Donec venenatis orci sit amet orci mollis, vitae tincidunt arcu convallis. Integer ac lectus enim.</p>
