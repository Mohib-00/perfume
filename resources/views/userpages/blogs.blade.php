    ...
    @include('userpages.cartmodel')
     ...
     <div class="single-blog-wrapper">
         ...
         <div class="single-blog-post-thumb">
            <img src="{{asset('essence/img/bg-img/bg-7.jpg')}}" alt="">
        </div>
